...
/* 
SystemsApiService Creates a YAML file with selected tables and downloads it
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param resetForm

@return *os.File
*/
func (a *SystemsApiService) DownloadResetVars(ctx context.Context, resetForm Reset) (*os.File, *http.Response, error) {
	var (
