...
/* 
FilesApiService Displays tapes containing specific file, related to the specific pool.
...
*/
func (a *FilesApiService) IndexTapesByFileByPool(ctx context.Context, poolId string, fileId int32) (TapeCollection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/* 
FilesApiService Displays tapes containing specific file, related to the specific task.
**API Key Scope**: files / tapes
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param taskId Numeric ID or name of task. Task names are not unique, it&#39;s recommanded to use numeric ID.
 * @param fileId Numeric ID of file.
...
@return TapeCollection
*/
func (a *FilesApiService) IndexTapesByFileByTask(ctx context.Context, taskId string, fileId int32) (TapeCollection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return TapeCollection
*/
func (a *FilesApiService) IndexTapesByFileByTaskExecution(ctx context.Context, taskExecutionId string, fileId int32) (TapeCollection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return TapeCollection
*/
func (a *FilesApiService) IndexTapesByFileByTaskExecutionByTask(ctx context.Context, taskId string, taskExecutionId string, fileId int32) (TapeCollection, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
