...
// OnTapesFileCollection struct for OnTapesFileCollection
type OnTapesFileCollection struct {
	Count *int32 `json:"count,omitempty"`
	OnTapesFiles *[]OnTapesFile `json:"on_tapes_files,omitempty"`
}
...
// GetOnTapesFiles returns the OnTapesFiles field value if set, zero value otherwise.
func (o *OnTapesFileCollection) GetOnTapesFiles() []OnTapesFile {
	if o == nil || o.OnTapesFiles == nil {
		var ret []OnTapesFile
		return ret
	}
	return *o.OnTapesFiles
}

// GetOnTapesFilesOk returns a tuple with the OnTapesFiles field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableOnTapesFileCollection struct {
	Value OnTapesFileCollection
	ExplicitNull bool
}

func (v NullableOnTapesFileCollection) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableOnTapesFileCollection) UnmarshalJSON(src []byte) error {
