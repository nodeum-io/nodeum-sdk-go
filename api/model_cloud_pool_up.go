...
// CloudPoolUp struct for CloudPoolUp
...
type NullableCloudPoolUp struct {
	Value CloudPoolUp
	ExplicitNull bool
}

func (v NullableCloudPoolUp) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableCloudPoolUp) UnmarshalJSON(src []byte) error {
