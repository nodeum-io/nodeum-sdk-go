...
// IndexTapeDriveDevicesOpts Optional parameters for the method 'IndexTapeDriveDevices'
...
*/
func (a *TapeDrivesApiService) IndexTapeDriveDevices(ctx _context.Context, tapeLibraryId string, localVarOptionals *IndexTapeDriveDevicesOpts) (TapeDriveDeviceCollection, *_nethttp.Response, error) {
	var (
