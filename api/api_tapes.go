...
func (a *TapesApiService) IndexTapes(ctx _context.Context, localVarOptionals *IndexTapesOpts) (TapeCollection, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.IndexTapes")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tapes"
...
func (a *TapesApiService) IndexTapesByTapeLibrary(ctx _context.Context, tapeLibraryId string, localVarOptionals *IndexTapesByTapeLibraryOpts) (TapeCollection, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.IndexTapesByTapeLibrary")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_libraries/{tape_library_id}/tapes"
...
// IndexTapesByTapePoolOpts Optional parameters for the method 'IndexTapesByTapePool'
...
/*
IndexTapesByTapePool Lists all tapes.
**API Key Scope**: tapes / index
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return TapeCollection
*/
func (a *TapesApiService) IndexTapesByTapePool(ctx _context.Context, tapePoolId string, localVarOptionals *IndexTapesByTapePoolOpts) (TapeCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.IndexTapesByTapePool")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_pools/{tape_pool_id}/tapes"
...
func (a *TapesApiService) MountStatusTape(ctx _context.Context, tapeId string) (MountStatus, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.MountStatusTape")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tapes/{tape_id}/mount"
...
func (a *TapesApiService) MountStatusTapeByTapeLibrary(ctx _context.Context, tapeLibraryId string, tapeId string) (MountStatus, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.MountStatusTapeByTapeLibrary")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_libraries/{tape_library_id}/tapes/{tape_id}/mount"
	localVarPath = strings.Replace(localVarPath, "{"+"tape_library_id"+"}", _neturl.QueryEscape(parameterToString(tapeLibraryId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tape_id"+"}", _neturl.QueryEscape(parameterToString(tapeId, "")) , -1)
...
/*
MountStatusTapeByTapePool Get mount status of Tape.
**API Key Scope**: tapes / mount_status
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tapePoolId Numeric ID, or name of tape pool.
 * @param tapeId Numeric ID, or barcode of tape.
@return MountStatus
*/
func (a *TapesApiService) MountStatusTapeByTapePool(ctx _context.Context, tapePoolId string, tapeId string) (MountStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.MountStatusTapeByTapePool")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_pools/{tape_pool_id}/tapes/{tape_id}/mount"
	localVarPath = strings.Replace(localVarPath, "{"+"tape_pool_id"+"}", _neturl.QueryEscape(parameterToString(tapePoolId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tape_id"+"}", _neturl.QueryEscape(parameterToString(tapeId, "")) , -1)
...
func (a *TapesApiService) ShowTape(ctx _context.Context, tapeId string) (Tape, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.ShowTape")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tapes/{tape_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"tape_id"+"}", _neturl.QueryEscape(parameterToString(tapeId, "")) , -1)
...
func (a *TapesApiService) ShowTapeByTapeLibrary(ctx _context.Context, tapeLibraryId string, tapeId string) (Tape, *_nethttp.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.ShowTapeByTapeLibrary")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_libraries/{tape_library_id}/tapes/{tape_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"tape_library_id"+"}", _neturl.QueryEscape(parameterToString(tapeLibraryId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tape_id"+"}", _neturl.QueryEscape(parameterToString(tapeId, "")) , -1)
...
/*
ShowTapeByTapePool Displays a specific tape.
**API Key Scope**: tapes / show
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tapePoolId Numeric ID, or name of tape pool.
 * @param tapeId Numeric ID, or barcode of tape.
@return Tape
*/
func (a *TapesApiService) ShowTapeByTapePool(ctx _context.Context, tapePoolId string, tapeId string) (Tape, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(ctx, "TapesApiService.ShowTapeByTapePool")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/tape_pools/{tape_pool_id}/tapes/{tape_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"tape_pool_id"+"}", _neturl.QueryEscape(parameterToString(tapePoolId, "")) , -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tape_id"+"}", _neturl.QueryEscape(parameterToString(tapeId, "")) , -1)
