...
// TestResultCloudConnectorOpts Optional parameters for the method 'TestResultCloudConnector'
...
*/
func (a *CloudConnectorsApiService) TestResultCloudConnector(ctx _context.Context, localVarOptionals *TestResultCloudConnectorOpts) (CloudBucketSimpleCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
