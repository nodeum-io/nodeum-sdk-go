...
type NullableLessThanOrEqualTo struct {
	Value LessThanOrEqualTo
	ExplicitNull bool
}

func (v NullableLessThanOrEqualTo) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableLessThanOrEqualTo) UnmarshalJSON(src []byte) error {
