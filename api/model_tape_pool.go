...
type NullableTapePool struct {
	Value TapePool
	ExplicitNull bool
}

func (v NullableTapePool) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableTapePool) UnmarshalJSON(src []byte) error {
