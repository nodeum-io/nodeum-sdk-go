...
// CloudPool struct for CloudPool
...
type NullableCloudPool struct {
	Value CloudPool
	ExplicitNull bool
}

func (v NullableCloudPool) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableCloudPool) UnmarshalJSON(src []byte) error {
