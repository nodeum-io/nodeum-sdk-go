...
// IndexCloudBucketsByCloudPoolOpts Optional parameters for the method 'IndexCloudBucketsByCloudPool'
...
/*
IndexCloudBucketsByCloudPool Lists all cloud buckets.
**API Key Scope**: cloud_buckets / index
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
@return CloudBucketCollection
*/
func (a *CloudBucketsApiService) IndexCloudBucketsByCloudPool(ctx _context.Context, cloudPoolId string, localVarOptionals *IndexCloudBucketsByCloudPoolOpts) (CloudBucketCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
MountStatusCloudBucketByCloudPool Get mount status of Cloud bucket.
**API Key Scope**: cloud_buckets / mount_status
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudPoolId Numeric ID or name of cloud pool.
 * @param cloudBucketId Numeric ID or name of cloud bucket.
@return MountStatus
*/
func (a *CloudBucketsApiService) MountStatusCloudBucketByCloudPool(ctx _context.Context, cloudPoolId string, cloudBucketId string) (MountStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ShowCloudBucketByCloudPool Displays a specific cloud bucket.
**API Key Scope**: cloud_buckets / show
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudPoolId Numeric ID or name of cloud pool.
 * @param cloudBucketId Numeric ID or name of cloud bucket.
@return CloudBucket
*/
func (a *CloudBucketsApiService) ShowCloudBucketByCloudPool(ctx _context.Context, cloudPoolId string, cloudBucketId string) (CloudBucket, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// SyncResultCloudBucketsOpts Optional parameters for the method 'SyncResultCloudBuckets'
...
*/
func (a *CloudBucketsApiService) SyncResultCloudBuckets(ctx _context.Context, cloudConnectorId string, localVarOptionals *SyncResultCloudBucketsOpts) (CloudBucketSimpleCollection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
