...
// TapePoolCollection struct for TapePoolCollection
...
// GetTapePools returns the TapePools field value if set, zero value otherwise.
func (o *TapePoolCollection) GetTapePools() []TapePool {
	if o == nil || o.TapePools == nil {
		var ret []TapePool
		return ret
	}
	return *o.TapePools
...
// GetTapePoolsOk returns a tuple with the TapePools field value if set, zero value otherwise
// and a boolean to check if the value has been set.
...
type NullableTapePoolCollection struct {
	Value TapePoolCollection
	ExplicitNull bool
}

func (v NullableTapePoolCollection) MarshalJSON() ([]byte, error) {
    switch {
    case v.ExplicitNull:
...
func (v *NullableTapePoolCollection) UnmarshalJSON(src []byte) error {
