...
/*
ShowTaskMetadat Displays a specific task metadatum.
...
@return TaskMetadatum
*/
func (a *TaskMetadataApiService) ShowTaskMetadat(ctx _context.Context, taskId string, taskMetadatumId int32) (TaskMetadatum, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
