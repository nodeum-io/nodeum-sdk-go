...
// MountPointsApiService MountPointsApi service
type MountPointsApiService service

/*
CreateMountPoint Creates a new mount point.
...
@return MountPoint
*/
func (a *MountPointsApiService) CreateMountPoint(ctx _context.Context, mountPointBody MountPoint) (MountPoint, *_nethttp.Response, error) {
	var (
...
/*
DestroyMountPoint Destroys a specific mount point.
**API Key Scope**: mount_points / destroy
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mountPointId Numeric ID or name of mount point.
*/
func (a *MountPointsApiService) DestroyMountPoint(ctx _context.Context, mountPointId string) (*_nethttp.Response, error) {
	var (
...
// IndexMountPointsOpts Optional parameters for the method 'IndexMountPoints'
...
/*
IndexMountPoints Lists all mount points.
...
*/
func (a *MountPointsApiService) IndexMountPoints(ctx _context.Context, localVarOptionals *IndexMountPointsOpts) (MountPointCollection, *_nethttp.Response, error) {
	var (
...
/*
MountMountPoint Mount Mount Point.
**API Key Scope**: mount_points / mount
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mountPointId Numeric ID or name of mount point.
@return MountStatus
*/
func (a *MountPointsApiService) MountMountPoint(ctx _context.Context, mountPointId string) (MountStatus, *_nethttp.Response, error) {
	var (
...
/*
MountStatusMountPoint Get mount status of Mount Point.
**API Key Scope**: mount_points / mount_status
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mountPointId Numeric ID or name of mount point.
@return MountStatus
*/
func (a *MountPointsApiService) MountStatusMountPoint(ctx _context.Context, mountPointId string) (MountStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
ShowMountPoint Displays a specific mount point`.
**API Key Scope**: mount_points / show   Optional API Key Explicit Scope: mount_points / get_password
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mountPointId Numeric ID or name of mount point.
@return MountPoint
*/
func (a *MountPointsApiService) ShowMountPoint(ctx _context.Context, mountPointId string) (MountPoint, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UnmountMountPoint Unmount Mount Point.
**API Key Scope**: mount_points / unmount
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param mountPointId Numeric ID or name of mount point.
@return MountStatus
*/
func (a *MountPointsApiService) UnmountMountPoint(ctx _context.Context, mountPointId string) (MountStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
UpdateMountPoint Updates a specific mount point`.
...
@return MountPoint
*/
func (a *MountPointsApiService) UpdateMountPoint(ctx _context.Context, mountPointId string, mountPointBody MountPoint) (MountPoint, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
